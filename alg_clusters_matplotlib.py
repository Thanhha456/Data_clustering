"""
source http://www.codeskulptor.org/#alg_clusters_matplotlib.py
...
def plot_clusters(data_table, cluster_list, draw_centers=False):
    ...
    map_img = plt.imread(BytesIO(map_file.read()))
    ...
    plt.title("Kmeans clustering of US cancer risk DATA_3108_URL")
